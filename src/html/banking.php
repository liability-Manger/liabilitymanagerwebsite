    ...
    <div class="card-form">
      ...
      <div class="card-form__inner">
        <div class="card-input">
          ...
          <input type="password" id="cardNumber" class="card-input__input" v-mask="generateCardNumberMask" v-model="cardNumber" v-on:focus="focusInput" v-on:blur="blurInput" data-ref="cardNumber" autocomplete="off">
        </div>
        <div class="card-input">
